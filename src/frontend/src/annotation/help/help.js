...
export const helpModalData = {
    ...
    Finally, the statement card contains an audio player loaded with the podcast audio, you may click the green play \
    ...
    <p>For each card on a statement you must complete, an <strong style='color:red'>X</strong> will be displayed while the card is incomplete or fails validation, \
    and a <strong style='color:green'>✓</strong> is shown when the card is complete and has passed a basic validation. After you have received a \
    <strong style='color:green'>✓</strong> on all cards you will receive a <strong style='color:green'>✓</strong> for the statement as a whole \
    (show next to the navigation buttons) and are free to move to the next statement. Each card has a \
    ...
    <p>After you have received a <strong style='color:green'>✓</strong> for all cards contained on all statements, and completed \
    ...
    before being automatically redirected back to Prolific.</p>",
    ...
    contact us here on Prolific. We will be publishing a range of studies with different podcasts and tasks in the near future, including bonus \
